...
#path reference
data_path <- '/Users/brookesevchik/Box/Data/Anxiety_Cognitive_Maps/Pilot4/combinedData_Anxiety_Cognitive_Maps.csv' 
...
df_STAI_illegal <- read_csv('/Users/brookesevchik/Box/Data/Anxiety_Cognitive_Maps/Pilot4/STAI_scores_calculated.csv')
df_STAI_illegal
